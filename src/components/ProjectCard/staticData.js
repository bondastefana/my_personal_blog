...
const projectsData = [
  {
    ...
    gitUrl: 'https://github.com/bondastefana/news_widget_js'
  },
  {
    ...
    gitUrl: 'https://github.com/bondastefana/card_prototype_js'
  },
  {
    imagePath: NasaAPI,
    title: 'Nasa API',
    ...
    gitUrl: 'https://github.com/bondastefana/nasa_api_js'
  },

  {
    ...
    gitUrl: 'https://github.com/bondastefana/booklist_validation'
  },
  {
    imagePath: BMICalculation,
    title: 'BMI Calculation',
    description:
      'We’re at a nutrition center, and we have the data from our customers ( name, gender, height, weight). I wrote de JS code that prints out in the console the name, genre, BMI and type for each customer.',
    url:
  ...
  },
  {
    ...
    gitUrl: 'https://github.com/bondastefana/online_shop'
  }
]
...
const projectsDataReact = [
  {
    ...
    gitUrl: 'https://github.com/bondastefana/imdb_app_reactjs'
  },
  {
    ...
    gitUrl: 'https://github.com/bondastefana/NasaAPI_ReactJS'
  },
  {
    ...
    gitUrl: 'https://github.com/bondastefana/my_first_react_project'
  }
]
